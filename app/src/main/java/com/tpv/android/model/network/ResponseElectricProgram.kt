...
data class ResponseElectricProgram(
	...
	@field:SerializedName("electricdata")
	val electricdata: List<ElectricdataItem>,
...
data class ElectricCustomFieldsItem(
...
data class ElectricdataItem(

	@field:SerializedName("electric_custom_fields")
	val electricCustomFields: List<ElectricCustomFieldsItem>,
