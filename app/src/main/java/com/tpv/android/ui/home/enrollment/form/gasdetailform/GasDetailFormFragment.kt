...
class GasDetailFormFragment : Fragment() {
    ...
    private fun setValueInViewModel() {
        ...
        when (mViewModel.planType) {
            ...
            Plan.DUALFUEL.value -> {
                mViewModel.customerData.apply {
                    gasBillingAddress = mBinding.layoutBillingAddress.editAddress.value
                    gasBillingAddress2 = ""
                    gasServiceAddress = mBinding.layoutServiceAddress.editAddress.value
                    gasServiceAddress2 = ""
                    ...
                    gasBillingState = "MA"
                    gasBillingZip = mBinding.layoutBillingAddress.editZipcode.value
                    gasServiceZip = mBinding.layoutServiceAddress.editZipcode.value
